...
namespace FirstPersonMobileTools.DynamicFirstPerson
{
    ...
    #region Editor accessible field
        ...
        // Advanced Settings
        [SerializeField] public Bobbing m_WalkBob = new Bobbing(); // Bobbing for walking
        [SerializeField] public Bobbing m_IdleBob = new Bobbing(); // Bobbing for idling
        ...
        {
            var targetPosition = LissajousCurve(swayTime, swayAmountA, swayAmountB);
            swayPosition = Vector3.Lerp(swayPosition, targetPosition, Time.smoothDeltaTime * swayLerpSpeed);
            weaponSwayObject.position = swayPosition;
        }
